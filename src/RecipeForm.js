...
import { TbPlus, TbChevronUp, TbSearch, TbX, TbClock } from 'react-icons/tb';
...
function RecipeForm({ onAddRecipe, onCancel, initialRecipe = null }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md border border-cream-300 overflow-hidden mb-6">
      <div className="bg-terracotta-500 p-6 text-cream-50">
        <h2 className="text-2xl font-bold">{initialRecipe ? 'Rediger Oppskrift' : 'Ny Oppskrift'}</h2>
        <p className="text-cream-100">{initialRecipe ? 'Oppdater oppskriften' : 'Legg til en ny oppskrift i din samling'}</p>
      </div>
